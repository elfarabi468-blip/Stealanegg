...
if not WindUILoadOk or not WindUILoadResult then
    warn("[RamHub] WindUI failed to load: " .. tostring(WindUILoadResult))
    return
end
...
local DISCORD_LINK = "https://discord.gg/WbQ9GzxHp"
...
SettingsTab:Keybind({
    Title = "UI Keybind",
    Desc = "Key to open/close the RamHub UI.",
    Icon = "keyboard",
    Value = "K",
    CanChange = true,
...
SettingsTab:Button({
    Title = "Join Discord",
    Desc = "Copy the RamHub Discord invite link.",
    Icon = "message-circle",
    Callback = function()
...
if type(hookmetamethod) == "function" and type(getnamecallmethod) == "function" then
    ...
    warn("[RamHub] Namecall hook unavailable; Anti Rejoin/Kick hook is disabled.")
end
